...
if services_file is None:
    ...
    try:
        ...
        st.markdown(
    "<h3 style='margin-bottom: -6px;'>The Pudding Lists Details</h3>",
    unsafe_allow_html=True,
)

        st.markdown(
            "<div class='small-muted' style='margin-top: -7px;'>Use drop downs to view the lists of clients found for each report details.</div>",
            unsafe_allow_html=True,
        )
